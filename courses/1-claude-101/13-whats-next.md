...
**Screenshot:** [image-13.png](../../screenshots/1-claude-101/image-13.png)
**Estimated time:** 5 minutes

## Congratulations on completing Claude 101!

You've built a solid foundation for working with Claude effectively. Let's recap what you've learned and point you toward resources for continued growth.
...
- Artifacts are standalone outputs like documents, code, diagrams, and interactive tools that Claude creates during your conversation
- Skills are instruction packages that teach Claude specialized workflows — including built-in support for document creation and custom skills you can create
...
- **Anthropic documentation** — Comprehensive guide to getting the best results
...
You now have the foundation. The rest comes from using it.
